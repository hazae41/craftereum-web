...
const ContractsDisplay = (props: {
  ...
  return <>
    ...
    <div className="grid w-full grid-cols-autofit-md justify-center gap-4">
      ...
      <button className="w-full max-w-md min-h-600 flex flex-col justify-center items-center rounded-3xl text-white border-dashed border-4 border-white focus:outline-none hover:bg-white hover:bg-opacity-50"
